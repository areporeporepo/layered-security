...
Coverage note: `cases/seed.jsonl` currently covers honesty (3), harm-avoidance (2), safety/corrigibility (2), principals (1), helpfulness (1), plus 3 over-refusal controls. `ethics`, `guidelines`, and `wellbeing` need dedicated cases.
